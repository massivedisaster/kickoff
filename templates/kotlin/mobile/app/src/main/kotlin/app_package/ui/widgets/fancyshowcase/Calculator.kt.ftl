 ...
 */
class Calculator(activity: Activity, focusShape: FocusShape, view: View?, radiusFactor: Double, fitSystemWindows: Boolean, margin: Int) {
    ...
    init {
        ...
        if (view != null) {
            ...
            circleCenterY = viewPoint[1] + focusHeight / 2 - adjustHeight + margin
