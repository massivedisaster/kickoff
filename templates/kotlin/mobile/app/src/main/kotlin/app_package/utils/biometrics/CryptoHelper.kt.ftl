...
class CryptoHelper {
     ...
     */
    fun cryptoObject() = BiometricPrompt.CryptoObject(initCipher(generateKey()))
    ...
    private fun generateKey(): KeyStore {
        ...
        keyStore.load(null)
        keyGenerator.init(
            KeyGenParameterSpec.Builder(DEFAULT_BIOMETRIC_KEY, KeyProperties.PURPOSE_ENCRYPT or KeyProperties.PURPOSE_DECRYPT)
