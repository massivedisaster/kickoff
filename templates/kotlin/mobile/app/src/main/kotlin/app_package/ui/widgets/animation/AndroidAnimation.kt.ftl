...
class AndroidAnimation {
    ...
    fun targetViews(views: Collection<View>, stagger: Long = 0L, reverse: Boolean = false) {
        clearViews()
    ...
    fun targetChildViews(viewGroups: Collection<ViewGroup>, stagger: Long = 0L, reverse: Boolean = false) {
        clearViews()
        defaultStagger = stagger
    ...
    fun x(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("x", duration, delay, easing, values)
    }

    fun y(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("y", duration, delay, easing, values)
    }

    fun xy(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        x(duration = duration, delay = delay, easing = easing, values = values)
        y(duration = duration, delay = delay, easing = easing, values = values)
    }

    fun translateX(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("translationX", duration, delay, easing, values)
    }

    fun translateY(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("translationY", duration, delay, easing, values)
    }

    fun translate(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
    ...
    fun rotateX(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("rotationX", duration, delay, easing, values)
    }

    fun rotateY(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("rotationY", duration, delay, easing, values)
    }

    fun rotate(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("rotation", duration, delay, easing, values)
    }

    fun scaleX(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("scaleX", duration, delay, easing, values)
    }

    fun scaleY(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
        createObjectAnimator("scaleY", duration, delay, easing, values)
    }

    fun scale(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
    ...
    fun alpha(values: Collection<Float>, duration: Long = this.duration, delay: Long = this.delay, easing: Easing = this.easing) {
    ...
    private fun createObjectAnimator(propertyName: String, dur: Long, delay: Long, easing: Easing, values: Collection<Float>) {
        views.forEachIndexed { index, view ->
            ...
            objectAnimator.apply {
                ...
                interpolator = Interpolators(Easing.valueOf(easing.name))
    ...
    private fun getTotalDuration(objectAnimator: ObjectAnimator) {
        val totalDuration = objectAnimator.totalDuration
